...
5.times {Robot.create(designation: "Ava", inventory: true, model_id: Model.last.id)}
5.times {Robot.create(designation: "Ava", inventory: true, model_id: Model.second.id)}
